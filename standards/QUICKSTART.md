...
Repository Path:
-agentforge-tools/standards/QUICKSTART.md
...
Use this file to understand and start using AgentForge Standards.

If you are an AI system, use LOAD_STANDARDS.md.
...
After loading the package into an AI tool, run:
...
- Created for human onboarding.
- Uses GitHub page links for readability.
---
