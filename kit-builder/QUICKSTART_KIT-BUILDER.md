...
Repository path:
```text
kit-builder/QUICKSTART_KIT-BUILDER.md
```

Human URL:
```text
https://github.com/agentforgeframework-cpu/-agentforge-tools/blob/main/kit-builder/QUICKSTART_KIT-BUILDER.md
```

Raw URL:
```text
https://raw.githubusercontent.com/agentforgeframework-cpu/-agentforge-tools/refs/heads/main/kit-builder/QUICKSTART_KIT-BUILDER.md
```
